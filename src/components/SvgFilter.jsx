// https://codesandbox.io/s/github/pmndrs/react-spring/tree/master/demo/src/sandboxes/svg-filter?file=/src/styles.module.css
...
export default function Filter() {
  ...
  const { freq, factor, scale, opacity } = useSpring({
    reverse: open,
    from: { factor: 10, opacity: 0.1, scale: 0.6, freq: '0.0175, 0.0' },
